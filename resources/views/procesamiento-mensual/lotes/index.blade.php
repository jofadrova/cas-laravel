                ...
                <form method="GET" action="{{ route('procesamiento-mensual.lotes.index') }}">
                    <div class="row g-3 align-items-end">
                        <div class="col-md-3">
                            ...
                            <select name="mes" id="mes" class="form-select">
                                ...
                                @foreach($meses as $numero => $nombre)
                                    <option value="{{ $numero }}" @selected((string) request('mes') === (string) $numero)>
                                        {{ $nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="gestion" id="gestion" value="{{ request('gestion') }}" class="form-control" placeholder="{{ now()->year }}" >
                        </div>
                                ...
                                <td class="text-end">
                                    <div class="dropdown toolbox-dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow toolbox-dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="{{ route('procesamiento-mensual.lotes.show',$lote) }}">
                                            ...
                                            @if($lote->puedeEditar())
                                                <li>
                                                    <a class="dropdown-item" href="{{ route( 'procesamiento-mensual.lotes.edit', $lote ) }}">
