<x-app-layout>
    ...
    <x-slot name="header">
        Reporte Ejecutivo por Tipo de Préstamo
    </x-slot>
    ...
    <div class="container-fluid px-0">
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body p-4">
                ...
                <form method="GET"
                      action="{{ route('prestamos.reportes.tipos-prestamo') }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="estado"
                            ...
                            <option value="AC"
                                @selected($estadoSeleccionado === 'AC')>
                                Activos
                            </option>

                            <option value="PA"
                                @selected($estadoSeleccionado === 'PA')>
                                Pagados
                            </option>

                            <option value="CE"
                                @selected($estadoSeleccionado === 'CE')>
                                ...
                                <td class="pe-4">
                                    ...
                                    <div class="progress"
                                        ...
                                        <div class="progress-bar bg-success"
                                             role="progressbar"
                                             style="width: {{ min($tipo->participacion, 100) }}%">
                                        </div>
