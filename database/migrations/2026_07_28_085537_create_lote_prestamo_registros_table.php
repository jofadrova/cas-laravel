...
return new class extends Migration
{
    ...
    {
        Schema::create('lote_prestamo_registros', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(
                ...
                'lote_prestamo_archivo_fila_unique'
            );
            $table->index(['lote_mensual_id', 'estado']);
    ...
    {
        Schema::dropIfExists('lote_prestamo_registros');
    }
};
